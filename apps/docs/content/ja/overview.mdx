...
> 💡 **参考:**
> このダイアグラムは [Mermaid](https://mermaid-js.github.io/mermaid/#/) を使用して描かれています。このツールを使うと、テキストベースでダイアグラムを描くことができます。以下のコードをコピーして [Mermaid Live Editor](https://mermaid-js.github.io/mermaid-live-editor/) に貼り付けると、ダイアグラムを視覚的に確認できます。
